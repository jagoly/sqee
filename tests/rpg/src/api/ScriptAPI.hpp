...
public: //====================================================//
    ...
    api::SoundEdit play_sound_global(const std::string& path, uint group);

    api::SoundEdit play_sound_position(const std::string& path, uint group, Vec3F position);

    api::SoundEdit play_sound_entity(const std::string& path, uint group, Int32 entity);
...
private: //===================================================//
    ...
    void impl_play_sound(const std::string& path, uint group);
};
