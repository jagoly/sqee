...
#define IMGUI_STB_TRUETYPE_FILENAME <sqee/redist/imgui/imstb_truetype.hpp>
#define IMGUI_STB_RECT_PACK_FILENAME <sqee/redist/imgui/imstb_rectpack.hpp>
...
// sqee change: comment these typedefs out in imgui.hpp
// gcc defines int64/uint64 as long, imgui does long long
// these confuse templates, so we just make imgui use the std types
