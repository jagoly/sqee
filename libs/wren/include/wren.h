...
//============================================================================//
    ...
    #ifdef SQEE_WREN_EXPORT
        #define WREN_API __attribute__((dllexport))
    #else
        #define WREN_API __attribute__((dllimport))
    #endif
#elif defined(SQEE_WINDOWS) && defined(SQEE_MSVC)
    #ifdef SQEE_WREN_EXPORT
        #define WREN_API __declspec(dllexport)
    #else
        #define WREN_API __declspec(dllimport)
    #endif
#else
...
// hacky and not very safe, hopefully will be added to wren properly soon
WREN_API void wrenUnloadModule(WrenVM* vm, const char* module);
