...
void EntityEdit::set_unique_name(const std::string& name)
{
...
void ModelEdit::add_material(const std::string& path)
{
    entry->materials.push_back(api.caches.materials.acquire(path));
}

void ModelEdit::set_mesh(const std::string& path)
{
...
void SkeletonEdit::set_armature(const std::string& /*path*/)
{
