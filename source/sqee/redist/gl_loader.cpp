...
typedef void (MSVC_STDCALL *PFNDEBUGMESSAGECALLBACK)(GLDEBUGPROC, const void *);
PFNDEBUGMESSAGECALLBACK DebugMessageCallback = 0;
typedef void (MSVC_STDCALL *PFNDEBUGMESSAGECONTROL)(GLenum, GLenum, GLenum, GLsizei, const GLuint *, GLboolean);
PFNDEBUGMESSAGECONTROL DebugMessageControl = 0;
typedef void (MSVC_STDCALL *PFNDEBUGMESSAGEINSERT)(GLenum, GLenum, GLuint, GLenum, GLsizei, const GLchar *);
PFNDEBUGMESSAGEINSERT DebugMessageInsert = 0;
typedef GLuint (MSVC_STDCALL *PFNGETDEBUGMESSAGELOG)(GLuint, GLsizei, GLenum *, GLenum *, GLuint *, GLenum *, GLsizei *, GLchar *);
PFNGETDEBUGMESSAGELOG GetDebugMessageLog = 0;
typedef void (MSVC_STDCALL *PFNGETOBJECTLABEL)(GLenum, GLuint, GLsizei, GLsizei *, GLchar *);
PFNGETOBJECTLABEL GetObjectLabel = 0;
typedef void (MSVC_STDCALL *PFNGETOBJECTPTRLABEL)(const void *, GLsizei, GLsizei *, GLchar *);
PFNGETOBJECTPTRLABEL GetObjectPtrLabel = 0;
typedef void (MSVC_STDCALL *PFNGETPOINTERV)(GLenum, void **);
PFNGETPOINTERV GetPointerv = 0;
typedef void (MSVC_STDCALL *PFNOBJECTLABEL)(GLenum, GLuint, GLsizei, const GLchar *);
PFNOBJECTLABEL ObjectLabel = 0;
typedef void (MSVC_STDCALL *PFNOBJECTPTRLABEL)(const void *, GLsizei, const GLchar *);
PFNOBJECTPTRLABEL ObjectPtrLabel = 0;
typedef void (MSVC_STDCALL *PFNPOPDEBUGGROUP)(void);
PFNPOPDEBUGGROUP PopDebugGroup = 0;
typedef void (MSVC_STDCALL *PFNPUSHDEBUGGROUP)(GLenum, GLuint, GLsizei, const GLchar *);
...
typedef void (MSVC_STDCALL *PFNTEXSTORAGE1D)(GLenum, GLsizei, GLenum, GLsizei);
PFNTEXSTORAGE1D TexStorage1D = 0;
typedef void (MSVC_STDCALL *PFNTEXSTORAGE2D)(GLenum, GLsizei, GLenum, GLsizei, GLsizei);
PFNTEXSTORAGE2D TexStorage2D = 0;
typedef void (MSVC_STDCALL *PFNTEXSTORAGE3D)(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei);
...
typedef void (MSVC_STDCALL *PFNBUFFERSTORAGE)(GLenum, GLsizeiptr, const void *, GLbitfield);
...
typedef void (MSVC_STDCALL *PFNBINDTEXTUREUNIT)(GLuint, GLuint);
PFNBINDTEXTUREUNIT BindTextureUnit = 0;
typedef void (MSVC_STDCALL *PFNBLITNAMEDFRAMEBUFFER)(GLuint, GLuint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum);
PFNBLITNAMEDFRAMEBUFFER BlitNamedFramebuffer = 0;
typedef GLenum (MSVC_STDCALL *PFNCHECKNAMEDFRAMEBUFFERSTATUS)(GLuint, GLenum);
PFNCHECKNAMEDFRAMEBUFFERSTATUS CheckNamedFramebufferStatus = 0;
typedef void (MSVC_STDCALL *PFNCLEARNAMEDBUFFERDATA)(GLuint, GLenum, GLenum, GLenum, const void *);
PFNCLEARNAMEDBUFFERDATA ClearNamedBufferData = 0;
typedef void (MSVC_STDCALL *PFNCLEARNAMEDBUFFERSUBDATA)(GLuint, GLenum, GLintptr, GLsizeiptr, GLenum, GLenum, const void *);
PFNCLEARNAMEDBUFFERSUBDATA ClearNamedBufferSubData = 0;
typedef void (MSVC_STDCALL *PFNCLEARNAMEDFRAMEBUFFERFI)(GLuint, GLenum, GLint, const GLfloat, GLint);
PFNCLEARNAMEDFRAMEBUFFERFI ClearNamedFramebufferfi = 0;
typedef void (MSVC_STDCALL *PFNCLEARNAMEDFRAMEBUFFERFV)(GLuint, GLenum, GLint, const GLfloat *);
PFNCLEARNAMEDFRAMEBUFFERFV ClearNamedFramebufferfv = 0;
typedef void (MSVC_STDCALL *PFNCLEARNAMEDFRAMEBUFFERIV)(GLuint, GLenum, GLint, const GLint *);
PFNCLEARNAMEDFRAMEBUFFERIV ClearNamedFramebufferiv = 0;
typedef void (MSVC_STDCALL *PFNCLEARNAMEDFRAMEBUFFERUIV)(GLuint, GLenum, GLint, const GLuint *);
PFNCLEARNAMEDFRAMEBUFFERUIV ClearNamedFramebufferuiv = 0;
typedef void (MSVC_STDCALL *PFNCOMPRESSEDTEXTURESUBIMAGE1D)(GLuint, GLint, GLint, GLsizei, GLenum, GLsizei, const void *);
PFNCOMPRESSEDTEXTURESUBIMAGE1D CompressedTextureSubImage1D = 0;
typedef void (MSVC_STDCALL *PFNCOMPRESSEDTEXTURESUBIMAGE2D)(GLuint, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const void *);
PFNCOMPRESSEDTEXTURESUBIMAGE2D CompressedTextureSubImage2D = 0;
typedef void (MSVC_STDCALL *PFNCOMPRESSEDTEXTURESUBIMAGE3D)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const void *);
PFNCOMPRESSEDTEXTURESUBIMAGE3D CompressedTextureSubImage3D = 0;
typedef void (MSVC_STDCALL *PFNCOPYNAMEDBUFFERSUBDATA)(GLuint, GLuint, GLintptr, GLintptr, GLsizeiptr);
PFNCOPYNAMEDBUFFERSUBDATA CopyNamedBufferSubData = 0;
typedef void (MSVC_STDCALL *PFNCOPYTEXTURESUBIMAGE1D)(GLuint, GLint, GLint, GLint, GLint, GLsizei);
PFNCOPYTEXTURESUBIMAGE1D CopyTextureSubImage1D = 0;
typedef void (MSVC_STDCALL *PFNCOPYTEXTURESUBIMAGE2D)(GLuint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei);
PFNCOPYTEXTURESUBIMAGE2D CopyTextureSubImage2D = 0;
typedef void (MSVC_STDCALL *PFNCOPYTEXTURESUBIMAGE3D)(GLuint, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei);
PFNCOPYTEXTURESUBIMAGE3D CopyTextureSubImage3D = 0;
typedef void (MSVC_STDCALL *PFNCREATEBUFFERS)(GLsizei, GLuint *);
PFNCREATEBUFFERS CreateBuffers = 0;
typedef void (MSVC_STDCALL *PFNCREATEFRAMEBUFFERS)(GLsizei, GLuint *);
PFNCREATEFRAMEBUFFERS CreateFramebuffers = 0;
typedef void (MSVC_STDCALL *PFNCREATEPROGRAMPIPELINES)(GLsizei, GLuint *);
PFNCREATEPROGRAMPIPELINES CreateProgramPipelines = 0;
typedef void (MSVC_STDCALL *PFNCREATEQUERIES)(GLenum, GLsizei, GLuint *);
PFNCREATEQUERIES CreateQueries = 0;
typedef void (MSVC_STDCALL *PFNCREATERENDERBUFFERS)(GLsizei, GLuint *);
PFNCREATERENDERBUFFERS CreateRenderbuffers = 0;
typedef void (MSVC_STDCALL *PFNCREATESAMPLERS)(GLsizei, GLuint *);
PFNCREATESAMPLERS CreateSamplers = 0;
typedef void (MSVC_STDCALL *PFNCREATETEXTURES)(GLenum, GLsizei, GLuint *);
PFNCREATETEXTURES CreateTextures = 0;
typedef void (MSVC_STDCALL *PFNCREATETRANSFORMFEEDBACKS)(GLsizei, GLuint *);
PFNCREATETRANSFORMFEEDBACKS CreateTransformFeedbacks = 0;
typedef void (MSVC_STDCALL *PFNCREATEVERTEXARRAYS)(GLsizei, GLuint *);
PFNCREATEVERTEXARRAYS CreateVertexArrays = 0;
typedef void (MSVC_STDCALL *PFNDISABLEVERTEXARRAYATTRIB)(GLuint, GLuint);
PFNDISABLEVERTEXARRAYATTRIB DisableVertexArrayAttrib = 0;
typedef void (MSVC_STDCALL *PFNENABLEVERTEXARRAYATTRIB)(GLuint, GLuint);
PFNENABLEVERTEXARRAYATTRIB EnableVertexArrayAttrib = 0;
typedef void (MSVC_STDCALL *PFNFLUSHMAPPEDNAMEDBUFFERRANGE)(GLuint, GLintptr, GLsizeiptr);
PFNFLUSHMAPPEDNAMEDBUFFERRANGE FlushMappedNamedBufferRange = 0;
typedef void (MSVC_STDCALL *PFNGENERATETEXTUREMIPMAP)(GLuint);
PFNGENERATETEXTUREMIPMAP GenerateTextureMipmap = 0;
typedef void (MSVC_STDCALL *PFNGETCOMPRESSEDTEXTUREIMAGE)(GLuint, GLint, GLsizei, void *);
PFNGETCOMPRESSEDTEXTUREIMAGE GetCompressedTextureImage = 0;
typedef void (MSVC_STDCALL *PFNGETNAMEDBUFFERPARAMETERI64V)(GLuint, GLenum, GLint64 *);
PFNGETNAMEDBUFFERPARAMETERI64V GetNamedBufferParameteri64v = 0;
typedef void (MSVC_STDCALL *PFNGETNAMEDBUFFERPARAMETERIV)(GLuint, GLenum, GLint *);
PFNGETNAMEDBUFFERPARAMETERIV GetNamedBufferParameteriv = 0;
typedef void (MSVC_STDCALL *PFNGETNAMEDBUFFERPOINTERV)(GLuint, GLenum, void **);
PFNGETNAMEDBUFFERPOINTERV GetNamedBufferPointerv = 0;
typedef void (MSVC_STDCALL *PFNGETNAMEDBUFFERSUBDATA)(GLuint, GLintptr, GLsizeiptr, void *);
PFNGETNAMEDBUFFERSUBDATA GetNamedBufferSubData = 0;
typedef void (MSVC_STDCALL *PFNGETNAMEDFRAMEBUFFERATTACHMENTPARAMETERIV)(GLuint, GLenum, GLenum, GLint *);
PFNGETNAMEDFRAMEBUFFERATTACHMENTPARAMETERIV GetNamedFramebufferAttachmentParameteriv = 0;
typedef void (MSVC_STDCALL *PFNGETNAMEDFRAMEBUFFERPARAMETERIV)(GLuint, GLenum, GLint *);
PFNGETNAMEDFRAMEBUFFERPARAMETERIV GetNamedFramebufferParameteriv = 0;
typedef void (MSVC_STDCALL *PFNGETNAMEDRENDERBUFFERPARAMETERIV)(GLuint, GLenum, GLint *);
PFNGETNAMEDRENDERBUFFERPARAMETERIV GetNamedRenderbufferParameteriv = 0;
typedef void (MSVC_STDCALL *PFNGETQUERYBUFFEROBJECTI64V)(GLuint, GLuint, GLenum, GLintptr);
PFNGETQUERYBUFFEROBJECTI64V GetQueryBufferObjecti64v = 0;
typedef void (MSVC_STDCALL *PFNGETQUERYBUFFEROBJECTIV)(GLuint, GLuint, GLenum, GLintptr);
PFNGETQUERYBUFFEROBJECTIV GetQueryBufferObjectiv = 0;
typedef void (MSVC_STDCALL *PFNGETQUERYBUFFEROBJECTUI64V)(GLuint, GLuint, GLenum, GLintptr);
PFNGETQUERYBUFFEROBJECTUI64V GetQueryBufferObjectui64v = 0;
typedef void (MSVC_STDCALL *PFNGETQUERYBUFFEROBJECTUIV)(GLuint, GLuint, GLenum, GLintptr);
PFNGETQUERYBUFFEROBJECTUIV GetQueryBufferObjectuiv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXTUREIMAGE)(GLuint, GLint, GLenum, GLenum, GLsizei, void *);
PFNGETTEXTUREIMAGE GetTextureImage = 0;
typedef void (MSVC_STDCALL *PFNGETTEXTURELEVELPARAMETERFV)(GLuint, GLint, GLenum, GLfloat *);
PFNGETTEXTURELEVELPARAMETERFV GetTextureLevelParameterfv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXTURELEVELPARAMETERIV)(GLuint, GLint, GLenum, GLint *);
PFNGETTEXTURELEVELPARAMETERIV GetTextureLevelParameteriv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXTUREPARAMETERIIV)(GLuint, GLenum, GLint *);
PFNGETTEXTUREPARAMETERIIV GetTextureParameterIiv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXTUREPARAMETERIUIV)(GLuint, GLenum, GLuint *);
PFNGETTEXTUREPARAMETERIUIV GetTextureParameterIuiv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXTUREPARAMETERFV)(GLuint, GLenum, GLfloat *);
PFNGETTEXTUREPARAMETERFV GetTextureParameterfv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXTUREPARAMETERIV)(GLuint, GLenum, GLint *);
PFNGETTEXTUREPARAMETERIV GetTextureParameteriv = 0;
typedef void (MSVC_STDCALL *PFNGETTRANSFORMFEEDBACKI64_V)(GLuint, GLenum, GLuint, GLint64 *);
PFNGETTRANSFORMFEEDBACKI64_V GetTransformFeedbacki64_v = 0;
typedef void (MSVC_STDCALL *PFNGETTRANSFORMFEEDBACKI_V)(GLuint, GLenum, GLuint, GLint *);
PFNGETTRANSFORMFEEDBACKI_V GetTransformFeedbacki_v = 0;
typedef void (MSVC_STDCALL *PFNGETTRANSFORMFEEDBACKIV)(GLuint, GLenum, GLint *);
PFNGETTRANSFORMFEEDBACKIV GetTransformFeedbackiv = 0;
typedef void (MSVC_STDCALL *PFNGETVERTEXARRAYINDEXED64IV)(GLuint, GLuint, GLenum, GLint64 *);
PFNGETVERTEXARRAYINDEXED64IV GetVertexArrayIndexed64iv = 0;
typedef void (MSVC_STDCALL *PFNGETVERTEXARRAYINDEXEDIV)(GLuint, GLuint, GLenum, GLint *);
PFNGETVERTEXARRAYINDEXEDIV GetVertexArrayIndexediv = 0;
typedef void (MSVC_STDCALL *PFNGETVERTEXARRAYIV)(GLuint, GLenum, GLint *);
PFNGETVERTEXARRAYIV GetVertexArrayiv = 0;
typedef void (MSVC_STDCALL *PFNINVALIDATENAMEDFRAMEBUFFERDATA)(GLuint, GLsizei, const GLenum *);
PFNINVALIDATENAMEDFRAMEBUFFERDATA InvalidateNamedFramebufferData = 0;
typedef void (MSVC_STDCALL *PFNINVALIDATENAMEDFRAMEBUFFERSUBDATA)(GLuint, GLsizei, const GLenum *, GLint, GLint, GLsizei, GLsizei);
PFNINVALIDATENAMEDFRAMEBUFFERSUBDATA InvalidateNamedFramebufferSubData = 0;
typedef void * (MSVC_STDCALL *PFNMAPNAMEDBUFFER)(GLuint, GLenum);
PFNMAPNAMEDBUFFER MapNamedBuffer = 0;
typedef void * (MSVC_STDCALL *PFNMAPNAMEDBUFFERRANGE)(GLuint, GLintptr, GLsizeiptr, GLbitfield);
PFNMAPNAMEDBUFFERRANGE MapNamedBufferRange = 0;
typedef void (MSVC_STDCALL *PFNNAMEDBUFFERDATA)(GLuint, GLsizeiptr, const void *, GLenum);
PFNNAMEDBUFFERDATA NamedBufferData = 0;
typedef void (MSVC_STDCALL *PFNNAMEDBUFFERSTORAGE)(GLuint, GLsizeiptr, const void *, GLbitfield);
PFNNAMEDBUFFERSTORAGE NamedBufferStorage = 0;
typedef void (MSVC_STDCALL *PFNNAMEDBUFFERSUBDATA)(GLuint, GLintptr, GLsizeiptr, const void *);
PFNNAMEDBUFFERSUBDATA NamedBufferSubData = 0;
typedef void (MSVC_STDCALL *PFNNAMEDFRAMEBUFFERDRAWBUFFER)(GLuint, GLenum);
PFNNAMEDFRAMEBUFFERDRAWBUFFER NamedFramebufferDrawBuffer = 0;
typedef void (MSVC_STDCALL *PFNNAMEDFRAMEBUFFERDRAWBUFFERS)(GLuint, GLsizei, const GLenum *);
PFNNAMEDFRAMEBUFFERDRAWBUFFERS NamedFramebufferDrawBuffers = 0;
typedef void (MSVC_STDCALL *PFNNAMEDFRAMEBUFFERPARAMETERI)(GLuint, GLenum, GLint);
PFNNAMEDFRAMEBUFFERPARAMETERI NamedFramebufferParameteri = 0;
typedef void (MSVC_STDCALL *PFNNAMEDFRAMEBUFFERREADBUFFER)(GLuint, GLenum);
PFNNAMEDFRAMEBUFFERREADBUFFER NamedFramebufferReadBuffer = 0;
typedef void (MSVC_STDCALL *PFNNAMEDFRAMEBUFFERRENDERBUFFER)(GLuint, GLenum, GLenum, GLuint);
PFNNAMEDFRAMEBUFFERRENDERBUFFER NamedFramebufferRenderbuffer = 0;
typedef void (MSVC_STDCALL *PFNNAMEDFRAMEBUFFERTEXTURE)(GLuint, GLenum, GLuint, GLint);
PFNNAMEDFRAMEBUFFERTEXTURE NamedFramebufferTexture = 0;
typedef void (MSVC_STDCALL *PFNNAMEDFRAMEBUFFERTEXTURELAYER)(GLuint, GLenum, GLuint, GLint, GLint);
PFNNAMEDFRAMEBUFFERTEXTURELAYER NamedFramebufferTextureLayer = 0;
typedef void (MSVC_STDCALL *PFNNAMEDRENDERBUFFERSTORAGE)(GLuint, GLenum, GLsizei, GLsizei);
PFNNAMEDRENDERBUFFERSTORAGE NamedRenderbufferStorage = 0;
typedef void (MSVC_STDCALL *PFNNAMEDRENDERBUFFERSTORAGEMULTISAMPLE)(GLuint, GLsizei, GLenum, GLsizei, GLsizei);
PFNNAMEDRENDERBUFFERSTORAGEMULTISAMPLE NamedRenderbufferStorageMultisample = 0;
typedef void (MSVC_STDCALL *PFNTEXTUREBUFFER)(GLuint, GLenum, GLuint);
PFNTEXTUREBUFFER TextureBuffer = 0;
typedef void (MSVC_STDCALL *PFNTEXTUREBUFFERRANGE)(GLuint, GLenum, GLuint, GLintptr, GLsizeiptr);
PFNTEXTUREBUFFERRANGE TextureBufferRange = 0;
typedef void (MSVC_STDCALL *PFNTEXTUREPARAMETERIIV)(GLuint, GLenum, const GLint *);
PFNTEXTUREPARAMETERIIV TextureParameterIiv = 0;
typedef void (MSVC_STDCALL *PFNTEXTUREPARAMETERIUIV)(GLuint, GLenum, const GLuint *);
PFNTEXTUREPARAMETERIUIV TextureParameterIuiv = 0;
typedef void (MSVC_STDCALL *PFNTEXTUREPARAMETERF)(GLuint, GLenum, GLfloat);
PFNTEXTUREPARAMETERF TextureParameterf = 0;
typedef void (MSVC_STDCALL *PFNTEXTUREPARAMETERFV)(GLuint, GLenum, const GLfloat *);
PFNTEXTUREPARAMETERFV TextureParameterfv = 0;
typedef void (MSVC_STDCALL *PFNTEXTUREPARAMETERI)(GLuint, GLenum, GLint);
PFNTEXTUREPARAMETERI TextureParameteri = 0;
typedef void (MSVC_STDCALL *PFNTEXTUREPARAMETERIV)(GLuint, GLenum, const GLint *);
PFNTEXTUREPARAMETERIV TextureParameteriv = 0;
typedef void (MSVC_STDCALL *PFNTEXTURESTORAGE1D)(GLuint, GLsizei, GLenum, GLsizei);
PFNTEXTURESTORAGE1D TextureStorage1D = 0;
typedef void (MSVC_STDCALL *PFNTEXTURESTORAGE2D)(GLuint, GLsizei, GLenum, GLsizei, GLsizei);
PFNTEXTURESTORAGE2D TextureStorage2D = 0;
typedef void (MSVC_STDCALL *PFNTEXTURESTORAGE2DMULTISAMPLE)(GLuint, GLsizei, GLenum, GLsizei, GLsizei, GLboolean);
PFNTEXTURESTORAGE2DMULTISAMPLE TextureStorage2DMultisample = 0;
typedef void (MSVC_STDCALL *PFNTEXTURESTORAGE3D)(GLuint, GLsizei, GLenum, GLsizei, GLsizei, GLsizei);
PFNTEXTURESTORAGE3D TextureStorage3D = 0;
typedef void (MSVC_STDCALL *PFNTEXTURESTORAGE3DMULTISAMPLE)(GLuint, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, GLboolean);
PFNTEXTURESTORAGE3DMULTISAMPLE TextureStorage3DMultisample = 0;
typedef void (MSVC_STDCALL *PFNTEXTURESUBIMAGE1D)(GLuint, GLint, GLint, GLsizei, GLenum, GLenum, const void *);
PFNTEXTURESUBIMAGE1D TextureSubImage1D = 0;
typedef void (MSVC_STDCALL *PFNTEXTURESUBIMAGE2D)(GLuint, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const void *);
PFNTEXTURESUBIMAGE2D TextureSubImage2D = 0;
typedef void (MSVC_STDCALL *PFNTEXTURESUBIMAGE3D)(GLuint, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const void *);
PFNTEXTURESUBIMAGE3D TextureSubImage3D = 0;
typedef void (MSVC_STDCALL *PFNTRANSFORMFEEDBACKBUFFERBASE)(GLuint, GLuint, GLuint);
PFNTRANSFORMFEEDBACKBUFFERBASE TransformFeedbackBufferBase = 0;
typedef void (MSVC_STDCALL *PFNTRANSFORMFEEDBACKBUFFERRANGE)(GLuint, GLuint, GLuint, GLintptr, GLsizeiptr);
PFNTRANSFORMFEEDBACKBUFFERRANGE TransformFeedbackBufferRange = 0;
typedef GLboolean (MSVC_STDCALL *PFNUNMAPNAMEDBUFFER)(GLuint);
PFNUNMAPNAMEDBUFFER UnmapNamedBuffer = 0;
typedef void (MSVC_STDCALL *PFNVERTEXARRAYATTRIBBINDING)(GLuint, GLuint, GLuint);
PFNVERTEXARRAYATTRIBBINDING VertexArrayAttribBinding = 0;
typedef void (MSVC_STDCALL *PFNVERTEXARRAYATTRIBFORMAT)(GLuint, GLuint, GLint, GLenum, GLboolean, GLuint);
PFNVERTEXARRAYATTRIBFORMAT VertexArrayAttribFormat = 0;
typedef void (MSVC_STDCALL *PFNVERTEXARRAYATTRIBIFORMAT)(GLuint, GLuint, GLint, GLenum, GLuint);
PFNVERTEXARRAYATTRIBIFORMAT VertexArrayAttribIFormat = 0;
typedef void (MSVC_STDCALL *PFNVERTEXARRAYATTRIBLFORMAT)(GLuint, GLuint, GLint, GLenum, GLuint);
PFNVERTEXARRAYATTRIBLFORMAT VertexArrayAttribLFormat = 0;
typedef void (MSVC_STDCALL *PFNVERTEXARRAYBINDINGDIVISOR)(GLuint, GLuint, GLuint);
PFNVERTEXARRAYBINDINGDIVISOR VertexArrayBindingDivisor = 0;
typedef void (MSVC_STDCALL *PFNVERTEXARRAYELEMENTBUFFER)(GLuint, GLuint);
PFNVERTEXARRAYELEMENTBUFFER VertexArrayElementBuffer = 0;
typedef void (MSVC_STDCALL *PFNVERTEXARRAYVERTEXBUFFER)(GLuint, GLuint, GLuint, GLintptr, GLsizei);
PFNVERTEXARRAYVERTEXBUFFER VertexArrayVertexBuffer = 0;
typedef void (MSVC_STDCALL *PFNVERTEXARRAYVERTEXBUFFERS)(GLuint, GLuint, GLsizei, const GLuint *, const GLintptr *, const GLsizei *);
...
typedef void (MSVC_STDCALL *PFNACTIVESHADERPROGRAM)(GLuint, GLuint);
PFNACTIVESHADERPROGRAM ActiveShaderProgram = 0;
typedef void (MSVC_STDCALL *PFNBINDPROGRAMPIPELINE)(GLuint);
PFNBINDPROGRAMPIPELINE BindProgramPipeline = 0;
typedef GLuint (MSVC_STDCALL *PFNCREATESHADERPROGRAMV)(GLenum, GLsizei, const GLchar *const*);
PFNCREATESHADERPROGRAMV CreateShaderProgramv = 0;
typedef void (MSVC_STDCALL *PFNDELETEPROGRAMPIPELINES)(GLsizei, const GLuint *);
PFNDELETEPROGRAMPIPELINES DeleteProgramPipelines = 0;
typedef void (MSVC_STDCALL *PFNGENPROGRAMPIPELINES)(GLsizei, GLuint *);
PFNGENPROGRAMPIPELINES GenProgramPipelines = 0;
typedef void (MSVC_STDCALL *PFNGETPROGRAMPIPELINEINFOLOG)(GLuint, GLsizei, GLsizei *, GLchar *);
PFNGETPROGRAMPIPELINEINFOLOG GetProgramPipelineInfoLog = 0;
typedef void (MSVC_STDCALL *PFNGETPROGRAMPIPELINEIV)(GLuint, GLenum, GLint *);
PFNGETPROGRAMPIPELINEIV GetProgramPipelineiv = 0;
typedef GLboolean (MSVC_STDCALL *PFNISPROGRAMPIPELINE)(GLuint);
PFNISPROGRAMPIPELINE IsProgramPipeline = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM1D)(GLuint, GLint, GLdouble);
PFNPROGRAMUNIFORM1D ProgramUniform1d = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM1DV)(GLuint, GLint, GLsizei, const GLdouble *);
PFNPROGRAMUNIFORM1DV ProgramUniform1dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM1F)(GLuint, GLint, GLfloat);
PFNPROGRAMUNIFORM1F ProgramUniform1f = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM1FV)(GLuint, GLint, GLsizei, const GLfloat *);
PFNPROGRAMUNIFORM1FV ProgramUniform1fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM1I)(GLuint, GLint, GLint);
PFNPROGRAMUNIFORM1I ProgramUniform1i = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM1IV)(GLuint, GLint, GLsizei, const GLint *);
PFNPROGRAMUNIFORM1IV ProgramUniform1iv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM1UI)(GLuint, GLint, GLuint);
PFNPROGRAMUNIFORM1UI ProgramUniform1ui = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM1UIV)(GLuint, GLint, GLsizei, const GLuint *);
PFNPROGRAMUNIFORM1UIV ProgramUniform1uiv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM2D)(GLuint, GLint, GLdouble, GLdouble);
PFNPROGRAMUNIFORM2D ProgramUniform2d = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM2DV)(GLuint, GLint, GLsizei, const GLdouble *);
PFNPROGRAMUNIFORM2DV ProgramUniform2dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM2F)(GLuint, GLint, GLfloat, GLfloat);
PFNPROGRAMUNIFORM2F ProgramUniform2f = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM2FV)(GLuint, GLint, GLsizei, const GLfloat *);
PFNPROGRAMUNIFORM2FV ProgramUniform2fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM2I)(GLuint, GLint, GLint, GLint);
PFNPROGRAMUNIFORM2I ProgramUniform2i = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM2IV)(GLuint, GLint, GLsizei, const GLint *);
PFNPROGRAMUNIFORM2IV ProgramUniform2iv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM2UI)(GLuint, GLint, GLuint, GLuint);
PFNPROGRAMUNIFORM2UI ProgramUniform2ui = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM2UIV)(GLuint, GLint, GLsizei, const GLuint *);
PFNPROGRAMUNIFORM2UIV ProgramUniform2uiv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM3D)(GLuint, GLint, GLdouble, GLdouble, GLdouble);
PFNPROGRAMUNIFORM3D ProgramUniform3d = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM3DV)(GLuint, GLint, GLsizei, const GLdouble *);
PFNPROGRAMUNIFORM3DV ProgramUniform3dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM3F)(GLuint, GLint, GLfloat, GLfloat, GLfloat);
PFNPROGRAMUNIFORM3F ProgramUniform3f = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM3FV)(GLuint, GLint, GLsizei, const GLfloat *);
PFNPROGRAMUNIFORM3FV ProgramUniform3fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM3I)(GLuint, GLint, GLint, GLint, GLint);
PFNPROGRAMUNIFORM3I ProgramUniform3i = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM3IV)(GLuint, GLint, GLsizei, const GLint *);
PFNPROGRAMUNIFORM3IV ProgramUniform3iv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM3UI)(GLuint, GLint, GLuint, GLuint, GLuint);
PFNPROGRAMUNIFORM3UI ProgramUniform3ui = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM3UIV)(GLuint, GLint, GLsizei, const GLuint *);
PFNPROGRAMUNIFORM3UIV ProgramUniform3uiv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM4D)(GLuint, GLint, GLdouble, GLdouble, GLdouble, GLdouble);
PFNPROGRAMUNIFORM4D ProgramUniform4d = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM4DV)(GLuint, GLint, GLsizei, const GLdouble *);
PFNPROGRAMUNIFORM4DV ProgramUniform4dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM4F)(GLuint, GLint, GLfloat, GLfloat, GLfloat, GLfloat);
PFNPROGRAMUNIFORM4F ProgramUniform4f = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM4FV)(GLuint, GLint, GLsizei, const GLfloat *);
PFNPROGRAMUNIFORM4FV ProgramUniform4fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM4I)(GLuint, GLint, GLint, GLint, GLint, GLint);
PFNPROGRAMUNIFORM4I ProgramUniform4i = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM4IV)(GLuint, GLint, GLsizei, const GLint *);
PFNPROGRAMUNIFORM4IV ProgramUniform4iv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM4UI)(GLuint, GLint, GLuint, GLuint, GLuint, GLuint);
PFNPROGRAMUNIFORM4UI ProgramUniform4ui = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORM4UIV)(GLuint, GLint, GLsizei, const GLuint *);
PFNPROGRAMUNIFORM4UIV ProgramUniform4uiv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX2DV)(GLuint, GLint, GLsizei, GLboolean, const GLdouble *);
PFNPROGRAMUNIFORMMATRIX2DV ProgramUniformMatrix2dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX2FV)(GLuint, GLint, GLsizei, GLboolean, const GLfloat *);
PFNPROGRAMUNIFORMMATRIX2FV ProgramUniformMatrix2fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX2X3DV)(GLuint, GLint, GLsizei, GLboolean, const GLdouble *);
PFNPROGRAMUNIFORMMATRIX2X3DV ProgramUniformMatrix2x3dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX2X3FV)(GLuint, GLint, GLsizei, GLboolean, const GLfloat *);
PFNPROGRAMUNIFORMMATRIX2X3FV ProgramUniformMatrix2x3fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX2X4DV)(GLuint, GLint, GLsizei, GLboolean, const GLdouble *);
PFNPROGRAMUNIFORMMATRIX2X4DV ProgramUniformMatrix2x4dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX2X4FV)(GLuint, GLint, GLsizei, GLboolean, const GLfloat *);
PFNPROGRAMUNIFORMMATRIX2X4FV ProgramUniformMatrix2x4fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX3DV)(GLuint, GLint, GLsizei, GLboolean, const GLdouble *);
PFNPROGRAMUNIFORMMATRIX3DV ProgramUniformMatrix3dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX3FV)(GLuint, GLint, GLsizei, GLboolean, const GLfloat *);
PFNPROGRAMUNIFORMMATRIX3FV ProgramUniformMatrix3fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX3X2DV)(GLuint, GLint, GLsizei, GLboolean, const GLdouble *);
PFNPROGRAMUNIFORMMATRIX3X2DV ProgramUniformMatrix3x2dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX3X2FV)(GLuint, GLint, GLsizei, GLboolean, const GLfloat *);
PFNPROGRAMUNIFORMMATRIX3X2FV ProgramUniformMatrix3x2fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX3X4DV)(GLuint, GLint, GLsizei, GLboolean, const GLdouble *);
PFNPROGRAMUNIFORMMATRIX3X4DV ProgramUniformMatrix3x4dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX3X4FV)(GLuint, GLint, GLsizei, GLboolean, const GLfloat *);
PFNPROGRAMUNIFORMMATRIX3X4FV ProgramUniformMatrix3x4fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX4DV)(GLuint, GLint, GLsizei, GLboolean, const GLdouble *);
PFNPROGRAMUNIFORMMATRIX4DV ProgramUniformMatrix4dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX4FV)(GLuint, GLint, GLsizei, GLboolean, const GLfloat *);
PFNPROGRAMUNIFORMMATRIX4FV ProgramUniformMatrix4fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX4X2DV)(GLuint, GLint, GLsizei, GLboolean, const GLdouble *);
PFNPROGRAMUNIFORMMATRIX4X2DV ProgramUniformMatrix4x2dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX4X2FV)(GLuint, GLint, GLsizei, GLboolean, const GLfloat *);
PFNPROGRAMUNIFORMMATRIX4X2FV ProgramUniformMatrix4x2fv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX4X3DV)(GLuint, GLint, GLsizei, GLboolean, const GLdouble *);
PFNPROGRAMUNIFORMMATRIX4X3DV ProgramUniformMatrix4x3dv = 0;
typedef void (MSVC_STDCALL *PFNPROGRAMUNIFORMMATRIX4X3FV)(GLuint, GLint, GLsizei, GLboolean, const GLfloat *);
PFNPROGRAMUNIFORMMATRIX4X3FV ProgramUniformMatrix4x3fv = 0;
typedef void (MSVC_STDCALL *PFNUSEPROGRAMSTAGES)(GLuint, GLbitfield, GLuint);
PFNUSEPROGRAMSTAGES UseProgramStages = 0;
typedef void (MSVC_STDCALL *PFNVALIDATEPROGRAMPIPELINE)(GLuint);
...
typedef void (MSVC_STDCALL *PFNCLEARDEPTH)(GLdouble);
PFNCLEARDEPTH ClearDepth = 0;
typedef void (MSVC_STDCALL *PFNCLEARSTENCIL)(GLint);
PFNCLEARSTENCIL ClearStencil = 0;
typedef void (MSVC_STDCALL *PFNCOLORMASK)(GLboolean, GLboolean, GLboolean, GLboolean);
PFNCOLORMASK ColorMask = 0;
typedef void (MSVC_STDCALL *PFNCULLFACE)(GLenum);
PFNCULLFACE CullFace = 0;
typedef void (MSVC_STDCALL *PFNDEPTHFUNC)(GLenum);
PFNDEPTHFUNC DepthFunc = 0;
typedef void (MSVC_STDCALL *PFNDEPTHMASK)(GLboolean);
PFNDEPTHMASK DepthMask = 0;
typedef void (MSVC_STDCALL *PFNDEPTHRANGE)(GLdouble, GLdouble);
PFNDEPTHRANGE DepthRange = 0;
typedef void (MSVC_STDCALL *PFNDISABLE)(GLenum);
PFNDISABLE Disable = 0;
typedef void (MSVC_STDCALL *PFNDRAWBUFFER)(GLenum);
PFNDRAWBUFFER DrawBuffer = 0;
typedef void (MSVC_STDCALL *PFNENABLE)(GLenum);
PFNENABLE Enable = 0;
typedef void (MSVC_STDCALL *PFNFINISH)(void);
PFNFINISH Finish = 0;
typedef void (MSVC_STDCALL *PFNFLUSH)(void);
PFNFLUSH Flush = 0;
typedef void (MSVC_STDCALL *PFNFRONTFACE)(GLenum);
PFNFRONTFACE FrontFace = 0;
typedef void (MSVC_STDCALL *PFNGETBOOLEANV)(GLenum, GLboolean *);
PFNGETBOOLEANV GetBooleanv = 0;
typedef void (MSVC_STDCALL *PFNGETDOUBLEV)(GLenum, GLdouble *);
PFNGETDOUBLEV GetDoublev = 0;
typedef GLenum (MSVC_STDCALL *PFNGETERROR)(void);
PFNGETERROR GetError = 0;
typedef void (MSVC_STDCALL *PFNGETFLOATV)(GLenum, GLfloat *);
PFNGETFLOATV GetFloatv = 0;
typedef void (MSVC_STDCALL *PFNGETINTEGERV)(GLenum, GLint *);
PFNGETINTEGERV GetIntegerv = 0;
typedef const GLubyte * (MSVC_STDCALL *PFNGETSTRING)(GLenum);
PFNGETSTRING GetString = 0;
typedef void (MSVC_STDCALL *PFNGETTEXIMAGE)(GLenum, GLint, GLenum, GLenum, void *);
PFNGETTEXIMAGE GetTexImage = 0;
typedef void (MSVC_STDCALL *PFNGETTEXLEVELPARAMETERFV)(GLenum, GLint, GLenum, GLfloat *);
PFNGETTEXLEVELPARAMETERFV GetTexLevelParameterfv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXLEVELPARAMETERIV)(GLenum, GLint, GLenum, GLint *);
PFNGETTEXLEVELPARAMETERIV GetTexLevelParameteriv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXPARAMETERFV)(GLenum, GLenum, GLfloat *);
PFNGETTEXPARAMETERFV GetTexParameterfv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXPARAMETERIV)(GLenum, GLenum, GLint *);
PFNGETTEXPARAMETERIV GetTexParameteriv = 0;
typedef void (MSVC_STDCALL *PFNHINT)(GLenum, GLenum);
PFNHINT Hint = 0;
typedef GLboolean (MSVC_STDCALL *PFNISENABLED)(GLenum);
PFNISENABLED IsEnabled = 0;
typedef void (MSVC_STDCALL *PFNLINEWIDTH)(GLfloat);
PFNLINEWIDTH LineWidth = 0;
typedef void (MSVC_STDCALL *PFNLOGICOP)(GLenum);
PFNLOGICOP LogicOp = 0;
typedef void (MSVC_STDCALL *PFNPIXELSTOREF)(GLenum, GLfloat);
PFNPIXELSTOREF PixelStoref = 0;
typedef void (MSVC_STDCALL *PFNPIXELSTOREI)(GLenum, GLint);
PFNPIXELSTOREI PixelStorei = 0;
typedef void (MSVC_STDCALL *PFNPOINTSIZE)(GLfloat);
PFNPOINTSIZE PointSize = 0;
typedef void (MSVC_STDCALL *PFNPOLYGONMODE)(GLenum, GLenum);
PFNPOLYGONMODE PolygonMode = 0;
typedef void (MSVC_STDCALL *PFNREADBUFFER)(GLenum);
PFNREADBUFFER ReadBuffer = 0;
typedef void (MSVC_STDCALL *PFNREADPIXELS)(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void *);
PFNREADPIXELS ReadPixels = 0;
typedef void (MSVC_STDCALL *PFNSCISSOR)(GLint, GLint, GLsizei, GLsizei);
PFNSCISSOR Scissor = 0;
typedef void (MSVC_STDCALL *PFNSTENCILFUNC)(GLenum, GLint, GLuint);
PFNSTENCILFUNC StencilFunc = 0;
typedef void (MSVC_STDCALL *PFNSTENCILMASK)(GLuint);
PFNSTENCILMASK StencilMask = 0;
typedef void (MSVC_STDCALL *PFNSTENCILOP)(GLenum, GLenum, GLenum);
PFNSTENCILOP StencilOp = 0;
typedef void (MSVC_STDCALL *PFNTEXIMAGE1D)(GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, const void *);
PFNTEXIMAGE1D TexImage1D = 0;
typedef void (MSVC_STDCALL *PFNTEXIMAGE2D)(GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *);
PFNTEXIMAGE2D TexImage2D = 0;
typedef void (MSVC_STDCALL *PFNTEXPARAMETERF)(GLenum, GLenum, GLfloat);
PFNTEXPARAMETERF TexParameterf = 0;
typedef void (MSVC_STDCALL *PFNTEXPARAMETERFV)(GLenum, GLenum, const GLfloat *);
PFNTEXPARAMETERFV TexParameterfv = 0;
typedef void (MSVC_STDCALL *PFNTEXPARAMETERI)(GLenum, GLenum, GLint);
PFNTEXPARAMETERI TexParameteri = 0;
typedef void (MSVC_STDCALL *PFNTEXPARAMETERIV)(GLenum, GLenum, const GLint *);
PFNTEXPARAMETERIV TexParameteriv = 0;
typedef void (MSVC_STDCALL *PFNVIEWPORT)(GLint, GLint, GLsizei, GLsizei);
PFNVIEWPORT Viewport = 0;

typedef void (MSVC_STDCALL *PFNBINDTEXTURE)(GLenum, GLuint);
PFNBINDTEXTURE BindTexture = 0;
typedef void (MSVC_STDCALL *PFNCOPYTEXIMAGE1D)(GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLint);
PFNCOPYTEXIMAGE1D CopyTexImage1D = 0;
typedef void (MSVC_STDCALL *PFNCOPYTEXIMAGE2D)(GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint);
PFNCOPYTEXIMAGE2D CopyTexImage2D = 0;
typedef void (MSVC_STDCALL *PFNCOPYTEXSUBIMAGE1D)(GLenum, GLint, GLint, GLint, GLint, GLsizei);
PFNCOPYTEXSUBIMAGE1D CopyTexSubImage1D = 0;
typedef void (MSVC_STDCALL *PFNCOPYTEXSUBIMAGE2D)(GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei);
PFNCOPYTEXSUBIMAGE2D CopyTexSubImage2D = 0;
typedef void (MSVC_STDCALL *PFNDELETETEXTURES)(GLsizei, const GLuint *);
PFNDELETETEXTURES DeleteTextures = 0;
typedef void (MSVC_STDCALL *PFNDRAWARRAYS)(GLenum, GLint, GLsizei);
PFNDRAWARRAYS DrawArrays = 0;
typedef void (MSVC_STDCALL *PFNDRAWELEMENTS)(GLenum, GLsizei, GLenum, const void *);
PFNDRAWELEMENTS DrawElements = 0;
typedef void (MSVC_STDCALL *PFNGENTEXTURES)(GLsizei, GLuint *);
PFNGENTEXTURES GenTextures = 0;
typedef GLboolean (MSVC_STDCALL *PFNISTEXTURE)(GLuint);
PFNISTEXTURE IsTexture = 0;
typedef void (MSVC_STDCALL *PFNPOLYGONOFFSET)(GLfloat, GLfloat);
PFNPOLYGONOFFSET PolygonOffset = 0;
typedef void (MSVC_STDCALL *PFNTEXSUBIMAGE1D)(GLenum, GLint, GLint, GLsizei, GLenum, GLenum, const void *);
PFNTEXSUBIMAGE1D TexSubImage1D = 0;
typedef void (MSVC_STDCALL *PFNTEXSUBIMAGE2D)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const void *);
PFNTEXSUBIMAGE2D TexSubImage2D = 0;

typedef void (MSVC_STDCALL *PFNCOPYTEXSUBIMAGE3D)(GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei);
PFNCOPYTEXSUBIMAGE3D CopyTexSubImage3D = 0;
typedef void (MSVC_STDCALL *PFNDRAWRANGEELEMENTS)(GLenum, GLuint, GLuint, GLsizei, GLenum, const void *);
PFNDRAWRANGEELEMENTS DrawRangeElements = 0;
typedef void (MSVC_STDCALL *PFNTEXIMAGE3D)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *);
PFNTEXIMAGE3D TexImage3D = 0;
typedef void (MSVC_STDCALL *PFNTEXSUBIMAGE3D)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const void *);
PFNTEXSUBIMAGE3D TexSubImage3D = 0;

typedef void (MSVC_STDCALL *PFNACTIVETEXTURE)(GLenum);
PFNACTIVETEXTURE ActiveTexture = 0;
typedef void (MSVC_STDCALL *PFNCOMPRESSEDTEXIMAGE1D)(GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, const void *);
PFNCOMPRESSEDTEXIMAGE1D CompressedTexImage1D = 0;
typedef void (MSVC_STDCALL *PFNCOMPRESSEDTEXIMAGE2D)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const void *);
PFNCOMPRESSEDTEXIMAGE2D CompressedTexImage2D = 0;
typedef void (MSVC_STDCALL *PFNCOMPRESSEDTEXIMAGE3D)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const void *);
PFNCOMPRESSEDTEXIMAGE3D CompressedTexImage3D = 0;
typedef void (MSVC_STDCALL *PFNCOMPRESSEDTEXSUBIMAGE1D)(GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, const void *);
PFNCOMPRESSEDTEXSUBIMAGE1D CompressedTexSubImage1D = 0;
typedef void (MSVC_STDCALL *PFNCOMPRESSEDTEXSUBIMAGE2D)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const void *);
PFNCOMPRESSEDTEXSUBIMAGE2D CompressedTexSubImage2D = 0;
typedef void (MSVC_STDCALL *PFNCOMPRESSEDTEXSUBIMAGE3D)(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const void *);
PFNCOMPRESSEDTEXSUBIMAGE3D CompressedTexSubImage3D = 0;
typedef void (MSVC_STDCALL *PFNGETCOMPRESSEDTEXIMAGE)(GLenum, GLint, void *);
PFNGETCOMPRESSEDTEXIMAGE GetCompressedTexImage = 0;
typedef void (MSVC_STDCALL *PFNSAMPLECOVERAGE)(GLfloat, GLboolean);
PFNSAMPLECOVERAGE SampleCoverage = 0;

typedef void (MSVC_STDCALL *PFNBLENDCOLOR)(GLfloat, GLfloat, GLfloat, GLfloat);
PFNBLENDCOLOR BlendColor = 0;
typedef void (MSVC_STDCALL *PFNBLENDEQUATION)(GLenum);
PFNBLENDEQUATION BlendEquation = 0;
typedef void (MSVC_STDCALL *PFNBLENDFUNCSEPARATE)(GLenum, GLenum, GLenum, GLenum);
PFNBLENDFUNCSEPARATE BlendFuncSeparate = 0;
typedef void (MSVC_STDCALL *PFNMULTIDRAWARRAYS)(GLenum, const GLint *, const GLsizei *, GLsizei);
PFNMULTIDRAWARRAYS MultiDrawArrays = 0;
typedef void (MSVC_STDCALL *PFNMULTIDRAWELEMENTS)(GLenum, const GLsizei *, GLenum, const void *const*, GLsizei);
PFNMULTIDRAWELEMENTS MultiDrawElements = 0;
typedef void (MSVC_STDCALL *PFNPOINTPARAMETERF)(GLenum, GLfloat);
PFNPOINTPARAMETERF PointParameterf = 0;
typedef void (MSVC_STDCALL *PFNPOINTPARAMETERFV)(GLenum, const GLfloat *);
PFNPOINTPARAMETERFV PointParameterfv = 0;
typedef void (MSVC_STDCALL *PFNPOINTPARAMETERI)(GLenum, GLint);
PFNPOINTPARAMETERI PointParameteri = 0;
typedef void (MSVC_STDCALL *PFNPOINTPARAMETERIV)(GLenum, const GLint *);
PFNPOINTPARAMETERIV PointParameteriv = 0;

typedef void (MSVC_STDCALL *PFNBEGINQUERY)(GLenum, GLuint);
PFNBEGINQUERY BeginQuery = 0;
typedef void (MSVC_STDCALL *PFNBINDBUFFER)(GLenum, GLuint);
PFNBINDBUFFER BindBuffer = 0;
typedef void (MSVC_STDCALL *PFNBUFFERDATA)(GLenum, GLsizeiptr, const void *, GLenum);
PFNBUFFERDATA BufferData = 0;
typedef void (MSVC_STDCALL *PFNBUFFERSUBDATA)(GLenum, GLintptr, GLsizeiptr, const void *);
PFNBUFFERSUBDATA BufferSubData = 0;
typedef void (MSVC_STDCALL *PFNDELETEBUFFERS)(GLsizei, const GLuint *);
PFNDELETEBUFFERS DeleteBuffers = 0;
typedef void (MSVC_STDCALL *PFNDELETEQUERIES)(GLsizei, const GLuint *);
PFNDELETEQUERIES DeleteQueries = 0;
typedef void (MSVC_STDCALL *PFNENDQUERY)(GLenum);
PFNENDQUERY EndQuery = 0;
typedef void (MSVC_STDCALL *PFNGENBUFFERS)(GLsizei, GLuint *);
PFNGENBUFFERS GenBuffers = 0;
typedef void (MSVC_STDCALL *PFNGENQUERIES)(GLsizei, GLuint *);
PFNGENQUERIES GenQueries = 0;
typedef void (MSVC_STDCALL *PFNGETBUFFERPARAMETERIV)(GLenum, GLenum, GLint *);
PFNGETBUFFERPARAMETERIV GetBufferParameteriv = 0;
typedef void (MSVC_STDCALL *PFNGETBUFFERPOINTERV)(GLenum, GLenum, void **);
PFNGETBUFFERPOINTERV GetBufferPointerv = 0;
typedef void (MSVC_STDCALL *PFNGETBUFFERSUBDATA)(GLenum, GLintptr, GLsizeiptr, void *);
PFNGETBUFFERSUBDATA GetBufferSubData = 0;
typedef void (MSVC_STDCALL *PFNGETQUERYOBJECTIV)(GLuint, GLenum, GLint *);
PFNGETQUERYOBJECTIV GetQueryObjectiv = 0;
typedef void (MSVC_STDCALL *PFNGETQUERYOBJECTUIV)(GLuint, GLenum, GLuint *);
PFNGETQUERYOBJECTUIV GetQueryObjectuiv = 0;
typedef void (MSVC_STDCALL *PFNGETQUERYIV)(GLenum, GLenum, GLint *);
PFNGETQUERYIV GetQueryiv = 0;
typedef GLboolean (MSVC_STDCALL *PFNISBUFFER)(GLuint);
PFNISBUFFER IsBuffer = 0;
typedef GLboolean (MSVC_STDCALL *PFNISQUERY)(GLuint);
PFNISQUERY IsQuery = 0;
typedef void * (MSVC_STDCALL *PFNMAPBUFFER)(GLenum, GLenum);
PFNMAPBUFFER MapBuffer = 0;
typedef GLboolean (MSVC_STDCALL *PFNUNMAPBUFFER)(GLenum);
PFNUNMAPBUFFER UnmapBuffer = 0;

typedef void (MSVC_STDCALL *PFNATTACHSHADER)(GLuint, GLuint);
PFNATTACHSHADER AttachShader = 0;
typedef void (MSVC_STDCALL *PFNBINDATTRIBLOCATION)(GLuint, GLuint, const GLchar *);
PFNBINDATTRIBLOCATION BindAttribLocation = 0;
typedef void (MSVC_STDCALL *PFNBLENDEQUATIONSEPARATE)(GLenum, GLenum);
PFNBLENDEQUATIONSEPARATE BlendEquationSeparate = 0;
typedef void (MSVC_STDCALL *PFNCOMPILESHADER)(GLuint);
PFNCOMPILESHADER CompileShader = 0;
typedef GLuint (MSVC_STDCALL *PFNCREATEPROGRAM)(void);
PFNCREATEPROGRAM CreateProgram = 0;
typedef GLuint (MSVC_STDCALL *PFNCREATESHADER)(GLenum);
PFNCREATESHADER CreateShader = 0;
typedef void (MSVC_STDCALL *PFNDELETEPROGRAM)(GLuint);
PFNDELETEPROGRAM DeleteProgram = 0;
typedef void (MSVC_STDCALL *PFNDELETESHADER)(GLuint);
PFNDELETESHADER DeleteShader = 0;
typedef void (MSVC_STDCALL *PFNDETACHSHADER)(GLuint, GLuint);
PFNDETACHSHADER DetachShader = 0;
typedef void (MSVC_STDCALL *PFNDISABLEVERTEXATTRIBARRAY)(GLuint);
PFNDISABLEVERTEXATTRIBARRAY DisableVertexAttribArray = 0;
typedef void (MSVC_STDCALL *PFNDRAWBUFFERS)(GLsizei, const GLenum *);
PFNDRAWBUFFERS DrawBuffers = 0;
typedef void (MSVC_STDCALL *PFNENABLEVERTEXATTRIBARRAY)(GLuint);
PFNENABLEVERTEXATTRIBARRAY EnableVertexAttribArray = 0;
typedef void (MSVC_STDCALL *PFNGETACTIVEATTRIB)(GLuint, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLchar *);
PFNGETACTIVEATTRIB GetActiveAttrib = 0;
typedef void (MSVC_STDCALL *PFNGETACTIVEUNIFORM)(GLuint, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLchar *);
PFNGETACTIVEUNIFORM GetActiveUniform = 0;
typedef void (MSVC_STDCALL *PFNGETATTACHEDSHADERS)(GLuint, GLsizei, GLsizei *, GLuint *);
PFNGETATTACHEDSHADERS GetAttachedShaders = 0;
typedef GLint (MSVC_STDCALL *PFNGETATTRIBLOCATION)(GLuint, const GLchar *);
PFNGETATTRIBLOCATION GetAttribLocation = 0;
typedef void (MSVC_STDCALL *PFNGETPROGRAMINFOLOG)(GLuint, GLsizei, GLsizei *, GLchar *);
PFNGETPROGRAMINFOLOG GetProgramInfoLog = 0;
typedef void (MSVC_STDCALL *PFNGETPROGRAMIV)(GLuint, GLenum, GLint *);
PFNGETPROGRAMIV GetProgramiv = 0;
typedef void (MSVC_STDCALL *PFNGETSHADERINFOLOG)(GLuint, GLsizei, GLsizei *, GLchar *);
PFNGETSHADERINFOLOG GetShaderInfoLog = 0;
typedef void (MSVC_STDCALL *PFNGETSHADERSOURCE)(GLuint, GLsizei, GLsizei *, GLchar *);
PFNGETSHADERSOURCE GetShaderSource = 0;
typedef void (MSVC_STDCALL *PFNGETSHADERIV)(GLuint, GLenum, GLint *);
PFNGETSHADERIV GetShaderiv = 0;
typedef GLint (MSVC_STDCALL *PFNGETUNIFORMLOCATION)(GLuint, const GLchar *);
PFNGETUNIFORMLOCATION GetUniformLocation = 0;
typedef void (MSVC_STDCALL *PFNGETUNIFORMFV)(GLuint, GLint, GLfloat *);
PFNGETUNIFORMFV GetUniformfv = 0;
typedef void (MSVC_STDCALL *PFNGETUNIFORMIV)(GLuint, GLint, GLint *);
PFNGETUNIFORMIV GetUniformiv = 0;
typedef void (MSVC_STDCALL *PFNGETVERTEXATTRIBPOINTERV)(GLuint, GLenum, void **);
PFNGETVERTEXATTRIBPOINTERV GetVertexAttribPointerv = 0;
typedef void (MSVC_STDCALL *PFNGETVERTEXATTRIBDV)(GLuint, GLenum, GLdouble *);
PFNGETVERTEXATTRIBDV GetVertexAttribdv = 0;
typedef void (MSVC_STDCALL *PFNGETVERTEXATTRIBFV)(GLuint, GLenum, GLfloat *);
PFNGETVERTEXATTRIBFV GetVertexAttribfv = 0;
typedef void (MSVC_STDCALL *PFNGETVERTEXATTRIBIV)(GLuint, GLenum, GLint *);
PFNGETVERTEXATTRIBIV GetVertexAttribiv = 0;
typedef GLboolean (MSVC_STDCALL *PFNISPROGRAM)(GLuint);
PFNISPROGRAM IsProgram = 0;
typedef GLboolean (MSVC_STDCALL *PFNISSHADER)(GLuint);
PFNISSHADER IsShader = 0;
typedef void (MSVC_STDCALL *PFNLINKPROGRAM)(GLuint);
PFNLINKPROGRAM LinkProgram = 0;
typedef void (MSVC_STDCALL *PFNSHADERSOURCE)(GLuint, GLsizei, const GLchar *const*, const GLint *);
PFNSHADERSOURCE ShaderSource = 0;
typedef void (MSVC_STDCALL *PFNSTENCILFUNCSEPARATE)(GLenum, GLenum, GLint, GLuint);
PFNSTENCILFUNCSEPARATE StencilFuncSeparate = 0;
typedef void (MSVC_STDCALL *PFNSTENCILMASKSEPARATE)(GLenum, GLuint);
PFNSTENCILMASKSEPARATE StencilMaskSeparate = 0;
typedef void (MSVC_STDCALL *PFNSTENCILOPSEPARATE)(GLenum, GLenum, GLenum, GLenum);
PFNSTENCILOPSEPARATE StencilOpSeparate = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM1F)(GLint, GLfloat);
PFNUNIFORM1F Uniform1f = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM1FV)(GLint, GLsizei, const GLfloat *);
PFNUNIFORM1FV Uniform1fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM1I)(GLint, GLint);
PFNUNIFORM1I Uniform1i = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM1IV)(GLint, GLsizei, const GLint *);
PFNUNIFORM1IV Uniform1iv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM2F)(GLint, GLfloat, GLfloat);
PFNUNIFORM2F Uniform2f = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM2FV)(GLint, GLsizei, const GLfloat *);
PFNUNIFORM2FV Uniform2fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM2I)(GLint, GLint, GLint);
PFNUNIFORM2I Uniform2i = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM2IV)(GLint, GLsizei, const GLint *);
PFNUNIFORM2IV Uniform2iv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM3F)(GLint, GLfloat, GLfloat, GLfloat);
PFNUNIFORM3F Uniform3f = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM3FV)(GLint, GLsizei, const GLfloat *);
PFNUNIFORM3FV Uniform3fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM3I)(GLint, GLint, GLint, GLint);
PFNUNIFORM3I Uniform3i = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM3IV)(GLint, GLsizei, const GLint *);
PFNUNIFORM3IV Uniform3iv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM4F)(GLint, GLfloat, GLfloat, GLfloat, GLfloat);
PFNUNIFORM4F Uniform4f = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM4FV)(GLint, GLsizei, const GLfloat *);
PFNUNIFORM4FV Uniform4fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM4I)(GLint, GLint, GLint, GLint, GLint);
PFNUNIFORM4I Uniform4i = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM4IV)(GLint, GLsizei, const GLint *);
PFNUNIFORM4IV Uniform4iv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORMMATRIX2FV)(GLint, GLsizei, GLboolean, const GLfloat *);
PFNUNIFORMMATRIX2FV UniformMatrix2fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORMMATRIX3FV)(GLint, GLsizei, GLboolean, const GLfloat *);
PFNUNIFORMMATRIX3FV UniformMatrix3fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORMMATRIX4FV)(GLint, GLsizei, GLboolean, const GLfloat *);
PFNUNIFORMMATRIX4FV UniformMatrix4fv = 0;
typedef void (MSVC_STDCALL *PFNUSEPROGRAM)(GLuint);
PFNUSEPROGRAM UseProgram = 0;
typedef void (MSVC_STDCALL *PFNVALIDATEPROGRAM)(GLuint);
PFNVALIDATEPROGRAM ValidateProgram = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB1D)(GLuint, GLdouble);
PFNVERTEXATTRIB1D VertexAttrib1d = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB1DV)(GLuint, const GLdouble *);
PFNVERTEXATTRIB1DV VertexAttrib1dv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB1F)(GLuint, GLfloat);
PFNVERTEXATTRIB1F VertexAttrib1f = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB1FV)(GLuint, const GLfloat *);
PFNVERTEXATTRIB1FV VertexAttrib1fv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB1S)(GLuint, GLshort);
PFNVERTEXATTRIB1S VertexAttrib1s = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB1SV)(GLuint, const GLshort *);
PFNVERTEXATTRIB1SV VertexAttrib1sv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB2D)(GLuint, GLdouble, GLdouble);
PFNVERTEXATTRIB2D VertexAttrib2d = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB2DV)(GLuint, const GLdouble *);
PFNVERTEXATTRIB2DV VertexAttrib2dv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB2F)(GLuint, GLfloat, GLfloat);
PFNVERTEXATTRIB2F VertexAttrib2f = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB2FV)(GLuint, const GLfloat *);
PFNVERTEXATTRIB2FV VertexAttrib2fv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB2S)(GLuint, GLshort, GLshort);
PFNVERTEXATTRIB2S VertexAttrib2s = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB2SV)(GLuint, const GLshort *);
PFNVERTEXATTRIB2SV VertexAttrib2sv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB3D)(GLuint, GLdouble, GLdouble, GLdouble);
PFNVERTEXATTRIB3D VertexAttrib3d = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB3DV)(GLuint, const GLdouble *);
PFNVERTEXATTRIB3DV VertexAttrib3dv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB3F)(GLuint, GLfloat, GLfloat, GLfloat);
PFNVERTEXATTRIB3F VertexAttrib3f = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB3FV)(GLuint, const GLfloat *);
PFNVERTEXATTRIB3FV VertexAttrib3fv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB3S)(GLuint, GLshort, GLshort, GLshort);
PFNVERTEXATTRIB3S VertexAttrib3s = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB3SV)(GLuint, const GLshort *);
PFNVERTEXATTRIB3SV VertexAttrib3sv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4NBV)(GLuint, const GLbyte *);
PFNVERTEXATTRIB4NBV VertexAttrib4Nbv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4NIV)(GLuint, const GLint *);
PFNVERTEXATTRIB4NIV VertexAttrib4Niv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4NSV)(GLuint, const GLshort *);
PFNVERTEXATTRIB4NSV VertexAttrib4Nsv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4NUB)(GLuint, GLubyte, GLubyte, GLubyte, GLubyte);
PFNVERTEXATTRIB4NUB VertexAttrib4Nub = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4NUBV)(GLuint, const GLubyte *);
PFNVERTEXATTRIB4NUBV VertexAttrib4Nubv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4NUIV)(GLuint, const GLuint *);
PFNVERTEXATTRIB4NUIV VertexAttrib4Nuiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4NUSV)(GLuint, const GLushort *);
PFNVERTEXATTRIB4NUSV VertexAttrib4Nusv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4BV)(GLuint, const GLbyte *);
PFNVERTEXATTRIB4BV VertexAttrib4bv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4D)(GLuint, GLdouble, GLdouble, GLdouble, GLdouble);
PFNVERTEXATTRIB4D VertexAttrib4d = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4DV)(GLuint, const GLdouble *);
PFNVERTEXATTRIB4DV VertexAttrib4dv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4F)(GLuint, GLfloat, GLfloat, GLfloat, GLfloat);
PFNVERTEXATTRIB4F VertexAttrib4f = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4FV)(GLuint, const GLfloat *);
PFNVERTEXATTRIB4FV VertexAttrib4fv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4IV)(GLuint, const GLint *);
PFNVERTEXATTRIB4IV VertexAttrib4iv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4S)(GLuint, GLshort, GLshort, GLshort, GLshort);
PFNVERTEXATTRIB4S VertexAttrib4s = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4SV)(GLuint, const GLshort *);
PFNVERTEXATTRIB4SV VertexAttrib4sv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4UBV)(GLuint, const GLubyte *);
PFNVERTEXATTRIB4UBV VertexAttrib4ubv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4UIV)(GLuint, const GLuint *);
PFNVERTEXATTRIB4UIV VertexAttrib4uiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIB4USV)(GLuint, const GLushort *);
PFNVERTEXATTRIB4USV VertexAttrib4usv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBPOINTER)(GLuint, GLint, GLenum, GLboolean, GLsizei, const void *);
PFNVERTEXATTRIBPOINTER VertexAttribPointer = 0;

typedef void (MSVC_STDCALL *PFNUNIFORMMATRIX2X3FV)(GLint, GLsizei, GLboolean, const GLfloat *);
PFNUNIFORMMATRIX2X3FV UniformMatrix2x3fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORMMATRIX2X4FV)(GLint, GLsizei, GLboolean, const GLfloat *);
PFNUNIFORMMATRIX2X4FV UniformMatrix2x4fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORMMATRIX3X2FV)(GLint, GLsizei, GLboolean, const GLfloat *);
PFNUNIFORMMATRIX3X2FV UniformMatrix3x2fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORMMATRIX3X4FV)(GLint, GLsizei, GLboolean, const GLfloat *);
PFNUNIFORMMATRIX3X4FV UniformMatrix3x4fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORMMATRIX4X2FV)(GLint, GLsizei, GLboolean, const GLfloat *);
PFNUNIFORMMATRIX4X2FV UniformMatrix4x2fv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORMMATRIX4X3FV)(GLint, GLsizei, GLboolean, const GLfloat *);
PFNUNIFORMMATRIX4X3FV UniformMatrix4x3fv = 0;

typedef void (MSVC_STDCALL *PFNBEGINCONDITIONALRENDER)(GLuint, GLenum);
PFNBEGINCONDITIONALRENDER BeginConditionalRender = 0;
typedef void (MSVC_STDCALL *PFNBEGINTRANSFORMFEEDBACK)(GLenum);
PFNBEGINTRANSFORMFEEDBACK BeginTransformFeedback = 0;
typedef void (MSVC_STDCALL *PFNBINDBUFFERBASE)(GLenum, GLuint, GLuint);
PFNBINDBUFFERBASE BindBufferBase = 0;
typedef void (MSVC_STDCALL *PFNBINDBUFFERRANGE)(GLenum, GLuint, GLuint, GLintptr, GLsizeiptr);
PFNBINDBUFFERRANGE BindBufferRange = 0;
typedef void (MSVC_STDCALL *PFNBINDFRAGDATALOCATION)(GLuint, GLuint, const GLchar *);
PFNBINDFRAGDATALOCATION BindFragDataLocation = 0;
typedef void (MSVC_STDCALL *PFNBINDFRAMEBUFFER)(GLenum, GLuint);
PFNBINDFRAMEBUFFER BindFramebuffer = 0;
typedef void (MSVC_STDCALL *PFNBINDRENDERBUFFER)(GLenum, GLuint);
PFNBINDRENDERBUFFER BindRenderbuffer = 0;
typedef void (MSVC_STDCALL *PFNBINDVERTEXARRAY)(GLuint);
PFNBINDVERTEXARRAY BindVertexArray = 0;
typedef void (MSVC_STDCALL *PFNBLITFRAMEBUFFER)(GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum);
PFNBLITFRAMEBUFFER BlitFramebuffer = 0;
typedef GLenum (MSVC_STDCALL *PFNCHECKFRAMEBUFFERSTATUS)(GLenum);
PFNCHECKFRAMEBUFFERSTATUS CheckFramebufferStatus = 0;
typedef void (MSVC_STDCALL *PFNCLAMPCOLOR)(GLenum, GLenum);
PFNCLAMPCOLOR ClampColor = 0;
typedef void (MSVC_STDCALL *PFNCLEARBUFFERFI)(GLenum, GLint, GLfloat, GLint);
PFNCLEARBUFFERFI ClearBufferfi = 0;
typedef void (MSVC_STDCALL *PFNCLEARBUFFERFV)(GLenum, GLint, const GLfloat *);
PFNCLEARBUFFERFV ClearBufferfv = 0;
typedef void (MSVC_STDCALL *PFNCLEARBUFFERIV)(GLenum, GLint, const GLint *);
PFNCLEARBUFFERIV ClearBufferiv = 0;
typedef void (MSVC_STDCALL *PFNCLEARBUFFERUIV)(GLenum, GLint, const GLuint *);
PFNCLEARBUFFERUIV ClearBufferuiv = 0;
typedef void (MSVC_STDCALL *PFNCOLORMASKI)(GLuint, GLboolean, GLboolean, GLboolean, GLboolean);
PFNCOLORMASKI ColorMaski = 0;
typedef void (MSVC_STDCALL *PFNDELETEFRAMEBUFFERS)(GLsizei, const GLuint *);
PFNDELETEFRAMEBUFFERS DeleteFramebuffers = 0;
typedef void (MSVC_STDCALL *PFNDELETERENDERBUFFERS)(GLsizei, const GLuint *);
PFNDELETERENDERBUFFERS DeleteRenderbuffers = 0;
typedef void (MSVC_STDCALL *PFNDELETEVERTEXARRAYS)(GLsizei, const GLuint *);
PFNDELETEVERTEXARRAYS DeleteVertexArrays = 0;
typedef void (MSVC_STDCALL *PFNDISABLEI)(GLenum, GLuint);
PFNDISABLEI Disablei = 0;
typedef void (MSVC_STDCALL *PFNENABLEI)(GLenum, GLuint);
PFNENABLEI Enablei = 0;
typedef void (MSVC_STDCALL *PFNENDCONDITIONALRENDER)(void);
PFNENDCONDITIONALRENDER EndConditionalRender = 0;
typedef void (MSVC_STDCALL *PFNENDTRANSFORMFEEDBACK)(void);
PFNENDTRANSFORMFEEDBACK EndTransformFeedback = 0;
typedef void (MSVC_STDCALL *PFNFLUSHMAPPEDBUFFERRANGE)(GLenum, GLintptr, GLsizeiptr);
PFNFLUSHMAPPEDBUFFERRANGE FlushMappedBufferRange = 0;
typedef void (MSVC_STDCALL *PFNFRAMEBUFFERRENDERBUFFER)(GLenum, GLenum, GLenum, GLuint);
PFNFRAMEBUFFERRENDERBUFFER FramebufferRenderbuffer = 0;
typedef void (MSVC_STDCALL *PFNFRAMEBUFFERTEXTURE1D)(GLenum, GLenum, GLenum, GLuint, GLint);
PFNFRAMEBUFFERTEXTURE1D FramebufferTexture1D = 0;
typedef void (MSVC_STDCALL *PFNFRAMEBUFFERTEXTURE2D)(GLenum, GLenum, GLenum, GLuint, GLint);
PFNFRAMEBUFFERTEXTURE2D FramebufferTexture2D = 0;
typedef void (MSVC_STDCALL *PFNFRAMEBUFFERTEXTURE3D)(GLenum, GLenum, GLenum, GLuint, GLint, GLint);
PFNFRAMEBUFFERTEXTURE3D FramebufferTexture3D = 0;
typedef void (MSVC_STDCALL *PFNFRAMEBUFFERTEXTURELAYER)(GLenum, GLenum, GLuint, GLint, GLint);
PFNFRAMEBUFFERTEXTURELAYER FramebufferTextureLayer = 0;
typedef void (MSVC_STDCALL *PFNGENFRAMEBUFFERS)(GLsizei, GLuint *);
PFNGENFRAMEBUFFERS GenFramebuffers = 0;
typedef void (MSVC_STDCALL *PFNGENRENDERBUFFERS)(GLsizei, GLuint *);
PFNGENRENDERBUFFERS GenRenderbuffers = 0;
typedef void (MSVC_STDCALL *PFNGENVERTEXARRAYS)(GLsizei, GLuint *);
PFNGENVERTEXARRAYS GenVertexArrays = 0;
typedef void (MSVC_STDCALL *PFNGENERATEMIPMAP)(GLenum);
PFNGENERATEMIPMAP GenerateMipmap = 0;
typedef void (MSVC_STDCALL *PFNGETBOOLEANI_V)(GLenum, GLuint, GLboolean *);
PFNGETBOOLEANI_V GetBooleani_v = 0;
typedef GLint (MSVC_STDCALL *PFNGETFRAGDATALOCATION)(GLuint, const GLchar *);
PFNGETFRAGDATALOCATION GetFragDataLocation = 0;
typedef void (MSVC_STDCALL *PFNGETFRAMEBUFFERATTACHMENTPARAMETERIV)(GLenum, GLenum, GLenum, GLint *);
PFNGETFRAMEBUFFERATTACHMENTPARAMETERIV GetFramebufferAttachmentParameteriv = 0;
typedef void (MSVC_STDCALL *PFNGETINTEGERI_V)(GLenum, GLuint, GLint *);
PFNGETINTEGERI_V GetIntegeri_v = 0;
typedef void (MSVC_STDCALL *PFNGETRENDERBUFFERPARAMETERIV)(GLenum, GLenum, GLint *);
PFNGETRENDERBUFFERPARAMETERIV GetRenderbufferParameteriv = 0;
typedef const GLubyte * (MSVC_STDCALL *PFNGETSTRINGI)(GLenum, GLuint);
PFNGETSTRINGI GetStringi = 0;
typedef void (MSVC_STDCALL *PFNGETTEXPARAMETERIIV)(GLenum, GLenum, GLint *);
PFNGETTEXPARAMETERIIV GetTexParameterIiv = 0;
typedef void (MSVC_STDCALL *PFNGETTEXPARAMETERIUIV)(GLenum, GLenum, GLuint *);
PFNGETTEXPARAMETERIUIV GetTexParameterIuiv = 0;
typedef void (MSVC_STDCALL *PFNGETTRANSFORMFEEDBACKVARYING)(GLuint, GLuint, GLsizei, GLsizei *, GLsizei *, GLenum *, GLchar *);
PFNGETTRANSFORMFEEDBACKVARYING GetTransformFeedbackVarying = 0;
typedef void (MSVC_STDCALL *PFNGETUNIFORMUIV)(GLuint, GLint, GLuint *);
PFNGETUNIFORMUIV GetUniformuiv = 0;
typedef void (MSVC_STDCALL *PFNGETVERTEXATTRIBIIV)(GLuint, GLenum, GLint *);
PFNGETVERTEXATTRIBIIV GetVertexAttribIiv = 0;
typedef void (MSVC_STDCALL *PFNGETVERTEXATTRIBIUIV)(GLuint, GLenum, GLuint *);
PFNGETVERTEXATTRIBIUIV GetVertexAttribIuiv = 0;
typedef GLboolean (MSVC_STDCALL *PFNISENABLEDI)(GLenum, GLuint);
PFNISENABLEDI IsEnabledi = 0;
typedef GLboolean (MSVC_STDCALL *PFNISFRAMEBUFFER)(GLuint);
PFNISFRAMEBUFFER IsFramebuffer = 0;
typedef GLboolean (MSVC_STDCALL *PFNISRENDERBUFFER)(GLuint);
PFNISRENDERBUFFER IsRenderbuffer = 0;
typedef GLboolean (MSVC_STDCALL *PFNISVERTEXARRAY)(GLuint);
PFNISVERTEXARRAY IsVertexArray = 0;
typedef void * (MSVC_STDCALL *PFNMAPBUFFERRANGE)(GLenum, GLintptr, GLsizeiptr, GLbitfield);
PFNMAPBUFFERRANGE MapBufferRange = 0;
typedef void (MSVC_STDCALL *PFNRENDERBUFFERSTORAGE)(GLenum, GLenum, GLsizei, GLsizei);
PFNRENDERBUFFERSTORAGE RenderbufferStorage = 0;
typedef void (MSVC_STDCALL *PFNRENDERBUFFERSTORAGEMULTISAMPLE)(GLenum, GLsizei, GLenum, GLsizei, GLsizei);
PFNRENDERBUFFERSTORAGEMULTISAMPLE RenderbufferStorageMultisample = 0;
typedef void (MSVC_STDCALL *PFNTEXPARAMETERIIV)(GLenum, GLenum, const GLint *);
PFNTEXPARAMETERIIV TexParameterIiv = 0;
typedef void (MSVC_STDCALL *PFNTEXPARAMETERIUIV)(GLenum, GLenum, const GLuint *);
PFNTEXPARAMETERIUIV TexParameterIuiv = 0;
typedef void (MSVC_STDCALL *PFNTRANSFORMFEEDBACKVARYINGS)(GLuint, GLsizei, const GLchar *const*, GLenum);
PFNTRANSFORMFEEDBACKVARYINGS TransformFeedbackVaryings = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM1UI)(GLint, GLuint);
PFNUNIFORM1UI Uniform1ui = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM1UIV)(GLint, GLsizei, const GLuint *);
PFNUNIFORM1UIV Uniform1uiv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM2UI)(GLint, GLuint, GLuint);
PFNUNIFORM2UI Uniform2ui = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM2UIV)(GLint, GLsizei, const GLuint *);
PFNUNIFORM2UIV Uniform2uiv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM3UI)(GLint, GLuint, GLuint, GLuint);
PFNUNIFORM3UI Uniform3ui = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM3UIV)(GLint, GLsizei, const GLuint *);
PFNUNIFORM3UIV Uniform3uiv = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM4UI)(GLint, GLuint, GLuint, GLuint, GLuint);
PFNUNIFORM4UI Uniform4ui = 0;
typedef void (MSVC_STDCALL *PFNUNIFORM4UIV)(GLint, GLsizei, const GLuint *);
PFNUNIFORM4UIV Uniform4uiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI1I)(GLuint, GLint);
PFNVERTEXATTRIBI1I VertexAttribI1i = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI1IV)(GLuint, const GLint *);
PFNVERTEXATTRIBI1IV VertexAttribI1iv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI1UI)(GLuint, GLuint);
PFNVERTEXATTRIBI1UI VertexAttribI1ui = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI1UIV)(GLuint, const GLuint *);
PFNVERTEXATTRIBI1UIV VertexAttribI1uiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI2I)(GLuint, GLint, GLint);
PFNVERTEXATTRIBI2I VertexAttribI2i = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI2IV)(GLuint, const GLint *);
PFNVERTEXATTRIBI2IV VertexAttribI2iv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI2UI)(GLuint, GLuint, GLuint);
PFNVERTEXATTRIBI2UI VertexAttribI2ui = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI2UIV)(GLuint, const GLuint *);
PFNVERTEXATTRIBI2UIV VertexAttribI2uiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI3I)(GLuint, GLint, GLint, GLint);
PFNVERTEXATTRIBI3I VertexAttribI3i = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI3IV)(GLuint, const GLint *);
PFNVERTEXATTRIBI3IV VertexAttribI3iv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI3UI)(GLuint, GLuint, GLuint, GLuint);
PFNVERTEXATTRIBI3UI VertexAttribI3ui = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI3UIV)(GLuint, const GLuint *);
PFNVERTEXATTRIBI3UIV VertexAttribI3uiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI4BV)(GLuint, const GLbyte *);
PFNVERTEXATTRIBI4BV VertexAttribI4bv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI4I)(GLuint, GLint, GLint, GLint, GLint);
PFNVERTEXATTRIBI4I VertexAttribI4i = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI4IV)(GLuint, const GLint *);
PFNVERTEXATTRIBI4IV VertexAttribI4iv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI4SV)(GLuint, const GLshort *);
PFNVERTEXATTRIBI4SV VertexAttribI4sv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI4UBV)(GLuint, const GLubyte *);
PFNVERTEXATTRIBI4UBV VertexAttribI4ubv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI4UI)(GLuint, GLuint, GLuint, GLuint, GLuint);
PFNVERTEXATTRIBI4UI VertexAttribI4ui = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI4UIV)(GLuint, const GLuint *);
PFNVERTEXATTRIBI4UIV VertexAttribI4uiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBI4USV)(GLuint, const GLushort *);
PFNVERTEXATTRIBI4USV VertexAttribI4usv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBIPOINTER)(GLuint, GLint, GLenum, GLsizei, const void *);
PFNVERTEXATTRIBIPOINTER VertexAttribIPointer = 0;

typedef void (MSVC_STDCALL *PFNCOPYBUFFERSUBDATA)(GLenum, GLenum, GLintptr, GLintptr, GLsizeiptr);
PFNCOPYBUFFERSUBDATA CopyBufferSubData = 0;
typedef void (MSVC_STDCALL *PFNDRAWARRAYSINSTANCED)(GLenum, GLint, GLsizei, GLsizei);
PFNDRAWARRAYSINSTANCED DrawArraysInstanced = 0;
typedef void (MSVC_STDCALL *PFNDRAWELEMENTSINSTANCED)(GLenum, GLsizei, GLenum, const void *, GLsizei);
PFNDRAWELEMENTSINSTANCED DrawElementsInstanced = 0;
typedef void (MSVC_STDCALL *PFNGETACTIVEUNIFORMBLOCKNAME)(GLuint, GLuint, GLsizei, GLsizei *, GLchar *);
PFNGETACTIVEUNIFORMBLOCKNAME GetActiveUniformBlockName = 0;
typedef void (MSVC_STDCALL *PFNGETACTIVEUNIFORMBLOCKIV)(GLuint, GLuint, GLenum, GLint *);
PFNGETACTIVEUNIFORMBLOCKIV GetActiveUniformBlockiv = 0;
typedef void (MSVC_STDCALL *PFNGETACTIVEUNIFORMNAME)(GLuint, GLuint, GLsizei, GLsizei *, GLchar *);
PFNGETACTIVEUNIFORMNAME GetActiveUniformName = 0;
typedef void (MSVC_STDCALL *PFNGETACTIVEUNIFORMSIV)(GLuint, GLsizei, const GLuint *, GLenum, GLint *);
PFNGETACTIVEUNIFORMSIV GetActiveUniformsiv = 0;
typedef GLuint (MSVC_STDCALL *PFNGETUNIFORMBLOCKINDEX)(GLuint, const GLchar *);
PFNGETUNIFORMBLOCKINDEX GetUniformBlockIndex = 0;
typedef void (MSVC_STDCALL *PFNGETUNIFORMINDICES)(GLuint, GLsizei, const GLchar *const*, GLuint *);
PFNGETUNIFORMINDICES GetUniformIndices = 0;
typedef void (MSVC_STDCALL *PFNPRIMITIVERESTARTINDEX)(GLuint);
PFNPRIMITIVERESTARTINDEX PrimitiveRestartIndex = 0;
typedef void (MSVC_STDCALL *PFNTEXBUFFER)(GLenum, GLenum, GLuint);
PFNTEXBUFFER TexBuffer = 0;
typedef void (MSVC_STDCALL *PFNUNIFORMBLOCKBINDING)(GLuint, GLuint, GLuint);
PFNUNIFORMBLOCKBINDING UniformBlockBinding = 0;

typedef GLenum (MSVC_STDCALL *PFNCLIENTWAITSYNC)(GLsync, GLbitfield, GLuint64);
PFNCLIENTWAITSYNC ClientWaitSync = 0;
typedef void (MSVC_STDCALL *PFNDELETESYNC)(GLsync);
PFNDELETESYNC DeleteSync = 0;
typedef void (MSVC_STDCALL *PFNDRAWELEMENTSBASEVERTEX)(GLenum, GLsizei, GLenum, const void *, GLint);
PFNDRAWELEMENTSBASEVERTEX DrawElementsBaseVertex = 0;
typedef void (MSVC_STDCALL *PFNDRAWELEMENTSINSTANCEDBASEVERTEX)(GLenum, GLsizei, GLenum, const void *, GLsizei, GLint);
PFNDRAWELEMENTSINSTANCEDBASEVERTEX DrawElementsInstancedBaseVertex = 0;
typedef void (MSVC_STDCALL *PFNDRAWRANGEELEMENTSBASEVERTEX)(GLenum, GLuint, GLuint, GLsizei, GLenum, const void *, GLint);
PFNDRAWRANGEELEMENTSBASEVERTEX DrawRangeElementsBaseVertex = 0;
typedef GLsync (MSVC_STDCALL *PFNFENCESYNC)(GLenum, GLbitfield);
PFNFENCESYNC FenceSync = 0;
typedef void (MSVC_STDCALL *PFNFRAMEBUFFERTEXTURE)(GLenum, GLenum, GLuint, GLint);
PFNFRAMEBUFFERTEXTURE FramebufferTexture = 0;
typedef void (MSVC_STDCALL *PFNGETBUFFERPARAMETERI64V)(GLenum, GLenum, GLint64 *);
PFNGETBUFFERPARAMETERI64V GetBufferParameteri64v = 0;
typedef void (MSVC_STDCALL *PFNGETINTEGER64I_V)(GLenum, GLuint, GLint64 *);
PFNGETINTEGER64I_V GetInteger64i_v = 0;
typedef void (MSVC_STDCALL *PFNGETINTEGER64V)(GLenum, GLint64 *);
PFNGETINTEGER64V GetInteger64v = 0;
typedef void (MSVC_STDCALL *PFNGETMULTISAMPLEFV)(GLenum, GLuint, GLfloat *);
PFNGETMULTISAMPLEFV GetMultisamplefv = 0;
typedef void (MSVC_STDCALL *PFNGETSYNCIV)(GLsync, GLenum, GLsizei, GLsizei *, GLint *);
PFNGETSYNCIV GetSynciv = 0;
typedef GLboolean (MSVC_STDCALL *PFNISSYNC)(GLsync);
PFNISSYNC IsSync = 0;
typedef void (MSVC_STDCALL *PFNMULTIDRAWELEMENTSBASEVERTEX)(GLenum, const GLsizei *, GLenum, const void *const*, GLsizei, const GLint *);
PFNMULTIDRAWELEMENTSBASEVERTEX MultiDrawElementsBaseVertex = 0;
typedef void (MSVC_STDCALL *PFNPROVOKINGVERTEX)(GLenum);
PFNPROVOKINGVERTEX ProvokingVertex = 0;
typedef void (MSVC_STDCALL *PFNSAMPLEMASKI)(GLuint, GLbitfield);
PFNSAMPLEMASKI SampleMaski = 0;
typedef void (MSVC_STDCALL *PFNTEXIMAGE2DMULTISAMPLE)(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLboolean);
PFNTEXIMAGE2DMULTISAMPLE TexImage2DMultisample = 0;
typedef void (MSVC_STDCALL *PFNTEXIMAGE3DMULTISAMPLE)(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLsizei, GLboolean);
PFNTEXIMAGE3DMULTISAMPLE TexImage3DMultisample = 0;
typedef void (MSVC_STDCALL *PFNWAITSYNC)(GLsync, GLbitfield, GLuint64);
PFNWAITSYNC WaitSync = 0;

typedef void (MSVC_STDCALL *PFNBINDFRAGDATALOCATIONINDEXED)(GLuint, GLuint, GLuint, const GLchar *);
PFNBINDFRAGDATALOCATIONINDEXED BindFragDataLocationIndexed = 0;
typedef void (MSVC_STDCALL *PFNBINDSAMPLER)(GLuint, GLuint);
PFNBINDSAMPLER BindSampler = 0;
typedef void (MSVC_STDCALL *PFNDELETESAMPLERS)(GLsizei, const GLuint *);
PFNDELETESAMPLERS DeleteSamplers = 0;
typedef void (MSVC_STDCALL *PFNGENSAMPLERS)(GLsizei, GLuint *);
PFNGENSAMPLERS GenSamplers = 0;
typedef GLint (MSVC_STDCALL *PFNGETFRAGDATAINDEX)(GLuint, const GLchar *);
PFNGETFRAGDATAINDEX GetFragDataIndex = 0;
typedef void (MSVC_STDCALL *PFNGETQUERYOBJECTI64V)(GLuint, GLenum, GLint64 *);
PFNGETQUERYOBJECTI64V GetQueryObjecti64v = 0;
typedef void (MSVC_STDCALL *PFNGETQUERYOBJECTUI64V)(GLuint, GLenum, GLuint64 *);
PFNGETQUERYOBJECTUI64V GetQueryObjectui64v = 0;
typedef void (MSVC_STDCALL *PFNGETSAMPLERPARAMETERIIV)(GLuint, GLenum, GLint *);
PFNGETSAMPLERPARAMETERIIV GetSamplerParameterIiv = 0;
typedef void (MSVC_STDCALL *PFNGETSAMPLERPARAMETERIUIV)(GLuint, GLenum, GLuint *);
PFNGETSAMPLERPARAMETERIUIV GetSamplerParameterIuiv = 0;
typedef void (MSVC_STDCALL *PFNGETSAMPLERPARAMETERFV)(GLuint, GLenum, GLfloat *);
PFNGETSAMPLERPARAMETERFV GetSamplerParameterfv = 0;
typedef void (MSVC_STDCALL *PFNGETSAMPLERPARAMETERIV)(GLuint, GLenum, GLint *);
PFNGETSAMPLERPARAMETERIV GetSamplerParameteriv = 0;
typedef GLboolean (MSVC_STDCALL *PFNISSAMPLER)(GLuint);
PFNISSAMPLER IsSampler = 0;
typedef void (MSVC_STDCALL *PFNQUERYCOUNTER)(GLuint, GLenum);
PFNQUERYCOUNTER QueryCounter = 0;
typedef void (MSVC_STDCALL *PFNSAMPLERPARAMETERIIV)(GLuint, GLenum, const GLint *);
PFNSAMPLERPARAMETERIIV SamplerParameterIiv = 0;
typedef void (MSVC_STDCALL *PFNSAMPLERPARAMETERIUIV)(GLuint, GLenum, const GLuint *);
PFNSAMPLERPARAMETERIUIV SamplerParameterIuiv = 0;
typedef void (MSVC_STDCALL *PFNSAMPLERPARAMETERF)(GLuint, GLenum, GLfloat);
PFNSAMPLERPARAMETERF SamplerParameterf = 0;
typedef void (MSVC_STDCALL *PFNSAMPLERPARAMETERFV)(GLuint, GLenum, const GLfloat *);
PFNSAMPLERPARAMETERFV SamplerParameterfv = 0;
typedef void (MSVC_STDCALL *PFNSAMPLERPARAMETERI)(GLuint, GLenum, GLint);
PFNSAMPLERPARAMETERI SamplerParameteri = 0;
typedef void (MSVC_STDCALL *PFNSAMPLERPARAMETERIV)(GLuint, GLenum, const GLint *);
PFNSAMPLERPARAMETERIV SamplerParameteriv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBDIVISOR)(GLuint, GLuint);
PFNVERTEXATTRIBDIVISOR VertexAttribDivisor = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBP1UI)(GLuint, GLenum, GLboolean, GLuint);
PFNVERTEXATTRIBP1UI VertexAttribP1ui = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBP1UIV)(GLuint, GLenum, GLboolean, const GLuint *);
PFNVERTEXATTRIBP1UIV VertexAttribP1uiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBP2UI)(GLuint, GLenum, GLboolean, GLuint);
PFNVERTEXATTRIBP2UI VertexAttribP2ui = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBP2UIV)(GLuint, GLenum, GLboolean, const GLuint *);
PFNVERTEXATTRIBP2UIV VertexAttribP2uiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBP3UI)(GLuint, GLenum, GLboolean, GLuint);
PFNVERTEXATTRIBP3UI VertexAttribP3ui = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBP3UIV)(GLuint, GLenum, GLboolean, const GLuint *);
PFNVERTEXATTRIBP3UIV VertexAttribP3uiv = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBP4UI)(GLuint, GLenum, GLboolean, GLuint);
PFNVERTEXATTRIBP4UI VertexAttribP4ui = 0;
typedef void (MSVC_STDCALL *PFNVERTEXATTRIBP4UIV)(GLuint, GLenum, GLboolean, const GLuint *);
...
{
    table.reserve(5);
    table.push_back(MapEntry("GL_KHR_debug", &exts::var_KHR_debug, detail::Load_KHR_debug));
    table.push_back(MapEntry("GL_ARB_texture_storage", &exts::var_ARB_texture_storage, detail::Load_ARB_texture_storage));
...
void ProcExtsFromExtList(std::vector<MapEntry> &table)
{
    GLint iLoop;
    GLint iNumExtensions = 0;
    gl::detail::GetIntegerv(gl::NUM_EXTENSIONS, &iNumExtensions);

    for(iLoop = 0; iLoop < iNumExtensions; iLoop++)
    {
        const char *strExtensionName = (const char *)gl::detail::GetStringi(gl::EXTENSIONS, iLoop);
...
exts::LoadTest LoadFunctions()
{
    ...
    detail::GetIntegerv = reinterpret_cast<detail::PFNGETINTEGERV>(IntGetProcAddress("glGetIntegerv"));
    if(!detail::GetIntegerv) return exts::LoadTest();
    detail::GetStringi = reinterpret_cast<detail::PFNGETSTRINGI>(IntGetProcAddress("glGetStringi"));
    if(!detail::GetStringi) return exts::LoadTest();

    ProcExtsFromExtList(table);

    int numFailed = detail::LoadCoreFunctions();
...
{
    detail::GetIntegerv(MAJOR_VERSION, &g_major_version);
    detail::GetIntegerv(MINOR_VERSION, &g_minor_version);
}
