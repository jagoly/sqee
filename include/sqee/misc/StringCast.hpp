...
SQEE_API String chai_string(const Vec2I& arg);
SQEE_API String chai_string(const Vec2U& arg);
SQEE_API String chai_string(const Vec2F& arg);
...
SQEE_API String chai_string(const Vec3I& arg);
SQEE_API String chai_string(const Vec3U& arg);
SQEE_API String chai_string(const Vec3F& arg);
...
SQEE_API String chai_string(const Vec4I& arg);
SQEE_API String chai_string(const Vec4U& arg);
SQEE_API String chai_string(const Vec4F& arg);
...
SQEE_API String chai_string(const Mat3F& arg);
SQEE_API String chai_string(const Mat34F& arg);
SQEE_API String chai_string(const Mat4F& arg);

SQEE_API String chai_string(const QuatF& arg);
